 ...
 */
public class User_AssociationActions extends EntityAssociationActions<User_> {
    public User_AssociationActions(Supplier<Association<?>> associationSupplier) {
        super(associationSupplier, User_.class);
    }
}
