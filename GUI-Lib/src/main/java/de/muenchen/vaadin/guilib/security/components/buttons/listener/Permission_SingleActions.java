 ...
 */
public class Permission_SingleActions extends EntitySingleActions<Permission_> {
    public Permission_SingleActions(Supplier<Permission_> permissionSupplier) {
        super(permissionSupplier, Permission_.class);
    }
}
