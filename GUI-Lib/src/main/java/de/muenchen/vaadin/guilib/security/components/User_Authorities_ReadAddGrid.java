...
public class User_Authorities_ReadAddGrid extends CustomComponent {
    ...
    private GenericGrid<Authority> grid;

    public User_Authorities_ReadAddGrid(User_ViewController controller, String navigateToRead, String navigateToAdd) {

        this.controller = controller;

        grid = new GenericGrid<>(controller.getModel().getSelectedUserAuthorities(), Authority.Field.getProperties());

        ActionButton addButton = new ActionButton(User.class, SimpleAction.add);
