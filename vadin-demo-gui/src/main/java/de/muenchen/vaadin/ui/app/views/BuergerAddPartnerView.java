...
public class BuergerAddPartnerView extends DefaultBuergerView{
    ...
    @Autowired
    public BuergerAddPartnerView(BuergerViewController controller, BuergerI18nResolver resolver, MainUI ui) {
    ...
    protected void site() {
        ...
        ActionButton addSingle = new ActionButton(resolver, SimpleAction.add);
        BuergerAssociationActions actionsSingle = new BuergerAssociationActions(resolver,
