...
public class BuergerPartnerSearchTable extends CustomComponent {
    ...
    public BuergerPartnerSearchTable(final BuergerViewController controller, String navigateToForEdit, String navigateToForBack, String navigateToForCreate, String from, final TableActionButton.Builder... buttonfactory) {
