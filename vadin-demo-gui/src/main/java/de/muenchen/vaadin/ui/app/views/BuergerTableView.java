...
public class BuergerTableView extends DefaultBuergerView {
    ...
    @Autowired
    public BuergerTableView(BuergerViewController controller) {
        super(controller, "In dieser View werden alle bürger angezeigt <br> zum Bearbeiten den gewünschten bürger auswählen <br> anschließend erscheinen Schaltflächen Zum Bearbeiten.");
