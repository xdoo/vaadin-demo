...
public class BuergerDetailView extends DefaultBuergerView {
    ...
    protected void site() {
        ...
        // add kind tab
        childTab=controller.getViewFactory().generateChildTab(BuergerDetailView.NAME, BuergerCreateChildView.NAME, ChildSelectView.NAME, NAME);
        TabSheet.Tab kindTab = tabSheet.addTab(childTab);
        kindTab.setCaption("Kinder"); // TODO -> i18n
        


        partnerTab=controller.getViewFactory().generatePartnerTab(BuergerDetailView.NAME, BuergerCreateChildView.NAME, ChildSelectView.NAME, NAME);
