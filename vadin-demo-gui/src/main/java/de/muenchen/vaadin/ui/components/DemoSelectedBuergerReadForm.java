 ...
 * @author claus
 */
public class DemoSelectedBuergerReadForm extends SelectedBuergerForm {
     ...
     * @param navigateBack
     */
    public DemoSelectedBuergerReadForm(BuergerViewController controller, final String navigateToUpdate, String navigateBack) {
