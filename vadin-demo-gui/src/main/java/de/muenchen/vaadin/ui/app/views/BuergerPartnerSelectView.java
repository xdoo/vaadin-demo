...
public class BuergerPartnerSelectView extends DefaultBuergerView {
    ...
    protected void site() {
        ...
        table= this.controller.getViewFactory().generateBuergerPartnerSearchTable(BuergerUpdateView.NAME, BuergerDetailView.NAME, BuergerCreateView.NAME, ChildSelectView.NAME);
        addComponent(table);
    }
