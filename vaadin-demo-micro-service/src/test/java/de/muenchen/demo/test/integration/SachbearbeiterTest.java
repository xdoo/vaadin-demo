...
//        Sachbearbeiter pass = new Sachbearbeiter();
//        pass.setOid(oid);
//        pass.setFax("0895236987");
//        pass.setFunktion("director");
//        return pass;
//    }
//
//    @Test
...
//        p1.setOrganisationseinheit("P001");
...
//        assertEquals(response.getOrganisationseinheit(), "P001");
//        assertEquals(DomainConstants.M2, response.getMandant().getOid());
//
...
//        response = restTemplate.getForEntity(URL11, SachbearbeiterResource.class).getBody();
//
//        System.out.println(String.format("Sachbearbeiter konnte mit OID '%s' aus der DB (und dem Cache) gelöscht werden.", DomainConstants.M2_P004));
//
//    }
//
//    @Test
...
//        response = restTemplate.getForEntity(URL11, SachbearbeiterResource.class).getBody();
//        assertNull(response);
//        System.out.println(String.format("Sachbearbeiter  mit OID '%s'und OID '%s' konnte aus der DB (und dem Cache) gelöscht werden.", DomainConstants.M2_P020, DomainConstants.M2_P021));
//
//    }
//
//    @Test
