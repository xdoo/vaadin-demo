...
insert  into permissions (id,  mandant,perm_permission,oid) values ('1102','2','PERM_newSachbearbeiter','1102');									
insert  into permissions (id,  mandant,perm_permission,oid) values ('1103','2','PERM_querySachbearbeiter','1103');									
insert  into permissions (id,  mandant,perm_permission,oid) values ('1104','2','PERM_copySachbearbeiter','1104');									
insert  into permissions (id,  mandant,perm_permission,oid) values ('1105','2','PERM_readSachbearbeiter','1105');									
insert  into permissions (id,  mandant,perm_permission,oid) values ('1106','2','PERM_updateSachbearbeiter','1106');									
insert  into permissions (id,  mandant,perm_permission,oid) values ('1107','2','PERM_saveSachbearbeiter','1107');									
insert  into permissions (id,  mandant,perm_permission,oid) values ('1108','2','PERM_deleteSachbearbeiter','1108');
insert  into permissions (id,  mandant,perm_permission,oid) values ('1109','2','PERM_readSachbearbeiterBuerger','1109');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1110','2','PERM_releaseSachbearbeiterBuerger','1110');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1111','2','PERM_releaseSachbearbeiterAllBuerger','1111');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1112','2','PERM_releaseSachbearbeiterUser','1112');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1113','2','PERM_createBuergerSachbearbeiter','1113');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1114','2','PERM_addBuergerSachbearbeiter','1114');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1115','2','PERM_createUserSachbearbeiter','1115');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1116','2','PERM_addUserSachbearbeiter','1116');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1117','2','PERM_readSachbearbeiterUser','1117');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1118','2','PERM_readBuergerSachbearbeiter','1118');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1119','2','PERM_addSachbearbeiterBuerger','1119');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1120','2','PERM_createSachbearbeiterBuerger','1120');										
insert  into permissions (id,  mandant,perm_permission,oid) values ('1121','2','PERM_releaseBuergerAllSachbearbeiter','1121');										
