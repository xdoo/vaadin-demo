...
public class UserController {
    ...
    public ResponseEntity readUser(@PathVariable("oid") String oid) {
        ...
        UserResource resource = this.assembler.toResource(entity, HateoasRelations.SELF, HateoasRelations.COPY, HateoasRelations.NEW, HateoasRelations.DELETE, HateoasRelations.UPDATE);
        return ResponseEntity.ok(resource);
    }
