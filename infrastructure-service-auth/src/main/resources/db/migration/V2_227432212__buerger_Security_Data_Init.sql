...
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-000005f5e101','buerger_READ_Adresse');
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-00000bebc201','buerger_WRITE_Adresse');
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-000011e1a301','buerger_DELETE_Adresse');
...
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-000005f5e102','buerger_READ_Pass');
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-00000bebc202','buerger_WRITE_Pass');
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-000011e1a302','buerger_DELETE_Pass');
...
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-000005f5e103','buerger_READ_Sachbearbeiter');
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-00000bebc203','buerger_WRITE_Sachbearbeiter');
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-000011e1a303','buerger_DELETE_Sachbearbeiter');
...
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-000005f5e104','buerger_READ_Wohnung');
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-00000bebc204','buerger_WRITE_Wohnung');
insert into _permissions (oid,perm_permission) values ('00000000-0d8e-5714-0000-000011e1a304','buerger_DELETE_Wohnung');
insert into _authorities_permissions (authority_oid, permission_oid) values ('00000000-0d8e-5714-0000-000000000002','00000000-0d8e-5714-0000-000005f5e104');
insert into _authorities_permissions (authority_oid, permission_oid) values ('00000000-0d8e-5714-0000-000000000001','00000000-0d8e-5714-0000-000005f5e104');
insert into _authorities_permissions (authority_oid, permission_oid) values ('00000000-0d8e-5714-0000-000000000001','00000000-0d8e-5714-0000-00000bebc204');
insert into _authorities_permissions (authority_oid, permission_oid) values ('00000000-0d8e-5714-0000-000000000001','00000000-0d8e-5714-0000-000011e1a304');
