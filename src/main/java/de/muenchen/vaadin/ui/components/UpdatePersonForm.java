...
public class UpdatePersonForm extends CustomComponent {
    ...
    private void createForm() {
        ...
        // headline
        Label headline = new Label(util.readText(DefaultPersonView.I18N_BASE_PATH, I18nPaths.I18N_FORM_UPDATE_HEADLINE_LABEL));
        ...
        String label = util.readText(DefaultPersonView.I18N_BASE_PATH, I18nPaths.I18N_FORM_UPDATE_BUTTON_LABEL);
