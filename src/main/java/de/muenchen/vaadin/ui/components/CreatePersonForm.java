...
public class CreatePersonForm extends CustomComponent {
    ...
    public CreatePersonForm(VaadinUtil util, final PersonService service, final EventBus eventbus) {
        ...
        // headline
        Label headline = new Label(util.readText(PersonView.I18N_BASE_PATH, I18nPaths.I18N_FORM_CREATE_HEADLINE_LABEL));
        ...
        String label = util.readText(PersonView.I18N_BASE_PATH, I18nPaths.I18N_FORM_CREATE_BUTTON_LABEL);
