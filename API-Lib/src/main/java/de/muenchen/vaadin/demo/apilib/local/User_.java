 ...
 * This file was automatically generated by GAIA.
 */
public class User_ extends ResourceSupport {
     ...
     */
    public User_(String username, String forname, String surname, java.util.Date birthdate, String email, boolean userEnabled) {
	...
	public enum Field {
	 ...
	 /**
	  * A simple Enum for all the Relations ({@link User_#getLink(String)} of the User_.
	  * <p>
