...
public interface Buerger_Repository extends CrudRepository<Buerger_, Long> {
	...
	Buerger_ findByGeburtstag(@Param(value= "geburtstag") java.util.Date geburtstag);
	 ...
	 */
	java.util.List<Buerger_> findByKinderOid(@Param(value = "oid") Long oid);
	/**
	 ...
	 */
	Buerger_ findByPartnerOid(@Param(value = "oid") Long oid);
	/**
	 ...
	 */
	java.util.List<Buerger_> findByPassOid(@Param(value = "oid") Long oid);
	/**
	 ...
	 */
	java.util.List<Buerger_> findBySachbearbeiterOid(@Param(value = "oid") Long oid);
	/**
	 ...
	 */
	java.util.List<Buerger_> findByWohnungenOid(@Param(value = "oid") Long oid);
}
