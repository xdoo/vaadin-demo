...
@ExposesResourceFor(Sachbearbeiter_.class)
@RequestMapping("/sachbearbeiters/search")
public class Sachbearbeiter_SearchController {
		
    @Autowired
    QueryService service;

    @Autowired
    Sachbearbeiter_Repository repository;
    ...
    public ResponseEntity<?> findFullTextFuzzy(PersistentEntityResourceAssembler assembler, @Param("q") String q) {
	    ...
	    Class tmpClass = Sachbearbeiter_.class;
	    while (tmpClass != null) {
        ...
        Stream<Sachbearbeiter_> sachbearbeiterStream;
        try {
            sachbearbeiterStream = service.query(q, Sachbearbeiter_.class, annotatedFields.toArray(new String[annotatedFields.size()])).stream();
