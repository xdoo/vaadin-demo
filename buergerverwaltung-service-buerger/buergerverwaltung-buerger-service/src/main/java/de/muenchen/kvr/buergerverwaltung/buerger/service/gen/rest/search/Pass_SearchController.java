...
@ExposesResourceFor(Pass_.class)
@RequestMapping("/passs/search")
public class Pass_SearchController {
		
    @Autowired
    QueryService service;

    @Autowired
    Pass_Repository repository;
    ...
    public ResponseEntity<?> findFullTextFuzzy(PersistentEntityResourceAssembler assembler, @Param("q") String q) {
        ...
        Stream<Pass_> passStream;
        try {
            passStream = service.query(q, Pass_.class, annotatedFields.toArray(new String[annotatedFields.size()])).stream();
