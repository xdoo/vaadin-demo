...
public class Buerger_Form extends BaseComponent {
    ...
    private List<Field> buildFields() {
		...
		final TokenField staatsangehoerigkeiten = formUtil.createTokenField(Buerger_.Field.staatsangehoerigkeiten.name(), MoeglicheStaatsangehoerigkeiten_.class);
    ...
    public Buerger_ getBuerger() {
        try {
            ...
            throw new Validator.InvalidValueException("Cannot create Buerger.");
        }
