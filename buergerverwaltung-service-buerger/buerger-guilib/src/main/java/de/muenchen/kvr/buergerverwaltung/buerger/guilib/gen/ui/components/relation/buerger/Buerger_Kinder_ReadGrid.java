 ...
 * @author rene.zarwel
 */
public class Buerger_Kinder_ReadGrid extends GenericGrid<Buerger_> {
	 ...
	 */
    public Buerger_Kinder_ReadGrid(final Buerger_ViewController controller, final String navigateToRead) {
