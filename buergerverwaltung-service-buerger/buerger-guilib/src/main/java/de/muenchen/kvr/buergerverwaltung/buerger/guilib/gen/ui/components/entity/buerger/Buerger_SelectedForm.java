...
public class Buerger_SelectedForm extends Buerger_Form {
    ...
    private void update(reactor.bus.Event<?> event) {
        ...
        Buerger_ buerger = data.getSelectedBuerger().orElse(null);
        if(buerger != null){
			...
			final Buerger_ partner = data.getSelectedBuergerPartner().orElse(null);
			if (buerger != null) {
				if (partner != null)
				buerger.setPartner(partner.getId().getHref());
			}
			final Wohnung_ wohnungen = data.getSelectedBuergerWohnungen().orElse(null);
			if (buerger != null) {
				if (wohnungen != null)
			...
			final Pass_ pass = data.getSelectedBuergerPass().orElse(null);
			if (buerger != null) {
				if (pass != null)
