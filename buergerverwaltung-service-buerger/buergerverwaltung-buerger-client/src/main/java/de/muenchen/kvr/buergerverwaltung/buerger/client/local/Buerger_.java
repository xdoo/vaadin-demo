...
public class Buerger_ extends ResourceSupport {
	...
	@Size(min = 1)
	private Set<Adresse_> bisherigeWohnsitze = new java.util.HashSet<>();
	...
	public Set<Adresse_> getBisherigeWohnsitze(){
		return bisherigeWohnsitze;
	}
	public void setBisherigeWohnsitze(Set<Adresse_> value){
