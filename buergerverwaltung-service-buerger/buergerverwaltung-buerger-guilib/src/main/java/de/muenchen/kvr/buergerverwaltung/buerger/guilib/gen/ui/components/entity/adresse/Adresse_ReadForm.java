 ...
 * @author claus
 */
public class Adresse_ReadForm extends BaseComponent {
    ...
    private final ActionButton updateButton = new ActionButton(Adresse_.class, SimpleAction.update);

	/** The navigation for the update aciton. */
    private final NavigateActions updateNavigation;

    public Adresse_ReadForm(final String navigateToUpdate) {
