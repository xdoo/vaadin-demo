...
/**
 * Provides a full-featured Form for a Wohnung_. It allows to view the current selected wohnung and edit it.
 *
 * @author p.mueller
 * @version 1.0
 */
public class Wohnung_ReadWriteForm extends BaseComponent {
	...
	private final ActionButton cancelButton = new ActionButton(Wohnung_.class, SimpleAction.cancel);
	
	/** The button for the edit action. */
	private final ActionButton editButton = new ActionButton(Wohnung_.class, SimpleAction.update);

    /** The Form displaying the current selected Wohnung_. */
    ...
    /**
     * Create a new Wohnung_ReadWriteForm with the internationalization of the Controller.
     * It will navigate to the navigateBack value on the back button click.
     */
    public Wohnung_ReadWriteForm() {
    ...
    /**
     * Get the Wohnung_SelectedForm used by this RWForm.
     * @return The Wohnung_SelectedForm.
     */
