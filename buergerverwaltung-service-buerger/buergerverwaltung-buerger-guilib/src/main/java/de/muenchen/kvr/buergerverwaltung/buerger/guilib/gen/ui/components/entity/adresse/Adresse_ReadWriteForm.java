...
/**
 * Provides a full-featured Form for a Adresse_. It allows to view the current selected adresse and edit it.
 *
 * @author p.mueller
 * @version 1.0
 */
public class Adresse_ReadWriteForm extends BaseComponent {
	...
	private final ActionButton cancelButton = new ActionButton(Adresse_.class, SimpleAction.cancel);
	
	/** The button for the edit action. */
	private final ActionButton editButton = new ActionButton(Adresse_.class, SimpleAction.update);

    /** The Form displaying the current selected Adresse_. */
    ...
    /**
     * Create a new Adresse_ReadWriteForm with the internationalization of the Controller.
     * It will navigate to the navigateBack value on the back button click.
     */
    public Adresse_ReadWriteForm() {
    ...
    /**
     * Get the Adresse_SelectedForm used by this RWForm.
     * @return The Adresse_SelectedForm.
     */
