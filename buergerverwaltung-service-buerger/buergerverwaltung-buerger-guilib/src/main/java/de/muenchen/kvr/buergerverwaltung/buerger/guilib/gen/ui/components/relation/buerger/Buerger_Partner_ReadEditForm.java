...
public class Buerger_Partner_ReadEditForm extends BaseComponent {
	...
	/** The underlying form. */
    private final Buerger_Partner_Form partnerForm;

    /**
     * Formular zum Lesen eines {@link Buerger_}s. Über diesen Konstruktor kann zusätzlich eine Zielseite für die
     ...
     * @param navigateToAdd
     */
    public Buerger_Partner_ReadEditForm(final String navigateToRead, final String navigateToCreate, final String navigateToAdd, final String navigateToDelete) {
        partnerForm = new Buerger_Partner_Form() {
            @Override
    ...
    private void configureDeleteButton() {
        final Buerger_AssociationActions associationActions = new Buerger_AssociationActions(
                () -> new Association<>(getForm().getBuerger(), Buerger_.Rel.partner.name()));
