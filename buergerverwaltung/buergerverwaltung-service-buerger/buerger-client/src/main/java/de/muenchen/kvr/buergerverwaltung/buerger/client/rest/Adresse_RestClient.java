 ...
 */
public interface Adresse_RestClient {
    ...
    /**
     * Get all the Adresses (with matching tenancy).
     *
    ...
    /**
     * Get all the Adresses (with matching tenancy) on a specific endpoint.
     * <p>
    ...
    /**
     * Get all Adresse matched with string due to fuzzy search.
     * @param filter the string for the query
     * @return
     */
    List<Adresse_> findFullTextFuzzy(String filter);

    /**
     * Try to find one Adresse (with matching tenancy) by its ID / self relation.
     *
     * @param link The ID / self relation of the Adresse_.
     * @return an optional of the Adresse_.
     */
    ...
    /**
     * Create a new Adresse_, the returned Adresse_ will have the Links and its ID.
     * @param adresse The Adresse_ to create, it must not contain any links.
     * @return the created Adresse_ (with ID).
     */
    Adresse_ create(Adresse_ adresse);

    /**
     * Update the fields of a Adresse_ by the {@link Adresse_#getId()}.
     *
     * @param adresse The updated Adresse_ that will be saved.
