...
/**
 * Provides a simple Form for creating a new Wohnung_ as an Association.
 *
...
public class Buerger_Wohnungen_CreateForm extends Wohnung_CreateForm {
    ...
    /**
     * Formular zum Erstellen eines {@link Wohnung_}s. Über diesen Konstruktor kann zusätzlich eine Zielseite für die
	...
	protected void configureSaveButton() {
		final Buerger_AssociationActions buergerAssociationActions = new Buerger_AssociationActions(
			() -> new Association<>(getWohnung(), getRelationToCreate()));
