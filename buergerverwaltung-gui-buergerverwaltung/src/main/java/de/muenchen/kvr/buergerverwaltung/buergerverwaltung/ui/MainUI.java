package de.muenchen.kvr.buergerverwaltung.buergerverwaltung.ui;
...
//        this.security.setNavigator(this.navigator);
    ...
    public void loginEventHandler(reactor.bus.Event<?> event) {
        ...
        getNavigator().navigateTo(Startseite_View.NAME);
    }
	...
	public void setHelpContent(){
		helpContent.setValue(getCurrentI18nResolver().resolve("view_."+(getNavigator().getState().equals("")?"startseite":getNavigator().getState())+".helptext"));
	}
    ...
    private void addMenuItems() {
        this.menuItems.put(Startseite_View.NAME, BaseUI.getCurrentI18nResolver().resolve("view_.startseite.title"));
